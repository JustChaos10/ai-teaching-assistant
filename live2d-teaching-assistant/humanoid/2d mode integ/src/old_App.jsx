...
export default function App() {
  ...
  return (
    ...
    {/* change the above from <div className="app">*/}
      {/* ---- Sidebar ---- */}
      ...
      {/* ---- Avatar Area (3D Canvas removed; placeholder for Live2D) ---- */}
      <main className="canvasWrap" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f0f0f0' }}>
        <div style={{ textAlign: 'center', color: 'var(--muted)' }}>
          Live2D Avatar Placeholder<br />
          (Haru will load here with lip-sync)
        </div>
      </main>
    </div>
  );
