...
import type { Lecture, Quiz, Submission } from "@shared/schema";
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <Tabs defaultValue="lectures" className="space-y-6">
          ...
          <TabsContent value="results" className="space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-semibold text-foreground">Student Quiz Results</h2>
            </div>
            ...
            {submissionsLoading ? (
              ...
              <div className="space-y-4">
                {submissions.map((submission) => {
                  ...
                  const lecture = quiz ? lectures?.find((l) => l.id === quiz.lectureId) : undefined;
                      ...
                      <CardHeader className="pb-3">
                        <div className="flex items-start justify-between">
                          ...
                          <div className="text-right">
                            <div className={`text-2xl font-bold ${percentage >= 70 ? 'text-green-600' : percentage >= 50 ? 'text-yellow-600' : 'text-red-600'}`}>
                              {percentage}%
                            </div>
                            <p className="text-xs text-muted-foreground">
              ...
              <Card className="py-12">
                <CardContent className="text-center space-y-4">
                  <ClipboardList className="w-16 h-16 mx-auto text-muted-foreground" />
                  <p className="text-muted-foreground">
                    No quiz submissions yet. Students can take quizzes from the Student View!
                  </p>
                </CardContent>
              </Card>
            )}
